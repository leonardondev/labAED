...
{ public:
  ...
  private:
    ...
    bool ISearch(TreeEntry x, TreePointer t);
...
//------------------------------------------------------------
template< class TreeEntry >
bool BinarySearchTree<TreeEntry>::ISearch(TreeEntry x, TreePointer t)
{ t=root;
...
//------------------------------------------------------------
template< class TreeEntry >
bool BinarySearchTree<TreeEntry>::SearchInsert(TreeEntry e)
{ TreePointer t;
  ISearch(e,t);
  if(t != NULL){
  	t->count++;
...
//------------------------------------------------------------
template< class TreeEntry >
int BinarySearchTree<TreeEntry>::hMin()
{  return (log2(n+1)-1);
}

//------------------------------------------------------------
template< class TreeEntry >
int BinarySearchTree<TreeEntry>::getCount()
{	
}
//------------------------------------------------------------
template< class TreeEntry >
int BinarySearchTree<TreeEntry>::getnComp()
{	return nComp;
}
//------------------------------------------------------------
template< class TreeEntry >
int BinarySearchTree<TreeEntry>::getnWords()
{	return nWords;
}
//------------------------------------------------------------
